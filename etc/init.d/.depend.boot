TARGETS = mountkernfs.sh hostname.sh udev mountdevsubfs.sh networking rpcbind nfs-common mountall.sh mountall-bootclean.sh urandom hwclock.sh mountnfs.sh mountnfs-bootclean.sh checkroot.sh bootmisc.sh checkroot-bootclean.sh udev-finish kmod procps checkfs.sh
